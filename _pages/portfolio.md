...
feature_row_extra:
  ...
  - title: "IBM Data Visualization Course Final Project"
    excerpt: "Built two dashboards (sales performance and service operations tracking) using a provided auto sales dataset as the capstone for IBM's Data Visualization course - part of my ongoing IBM Data Analyst Professional Certification. Earned 100% on the final evaluation.\n\n[View Certificate](https://www.coursera.org/account/accomplishments/verify/VIWT9WKIZDSM){: .btn .btn--primary .btn--small} [View Dashboards](https://datastudio.google.com/reporting/af5804e6-a015-4cac-befe-5623a96ed910){: .btn .btn--primary .btn--small}"
---
